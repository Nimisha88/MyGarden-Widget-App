...
public class PlantWateringService extends IntentService {
    ...
    //public static final String EXTRA_WATER_PLANT_WIDGET_ID = "water_plant_id";
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        long plantID = 0;
        boolean displayWaterButton = false;
        if (cursor != null && cursor.getCount() > 0) {
            ...
            plantID = cursor.getLong(cursor.getColumnIndex(PlantContract.
                    PlantEntry._ID));
            cursor.close();
            imgRes = PlantUtils.getPlantImageRes(this, timeNow - createdAt, timeNow - wateredAt, plantType);
            displayWaterButton = ((timeNow - wateredAt) > PlantUtils.MIN_AGE_BETWEEN_WATER) &&
        ...
        PlantWidgetProvider.updatePlantWidgets(this, appWidgetManager, imgRes, plantID, displayWaterButton, appWidgetIds);
    }
}